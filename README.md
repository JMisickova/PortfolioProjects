...
The final dashboard answers the business question and hypotheses. It also allows marketers to quickly identify segments (and their characteristics) with the highest (or lowest) value and target campaigns accordingly.

## Results
Total Revenue: $338.40M
Revenue by RFM Segmenatiton: Big Spenders $154M (45,69% of Total Revenue)
...
Customers by RFM Segmentation:  Loyal Customers: 70 836 (24% of all customers)
